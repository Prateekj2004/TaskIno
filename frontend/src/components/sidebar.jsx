  ...
  return (
    <>
      ...
      <div className={SIDEBAR_CLASSES.desktop}>
        <div className='p-5 border-b border-slate-100 lg:block hidden'>
          <div className='flex items-center gap-3'>
            <div className='w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold shadow-md'>
              {initial}
            </div>
            <div>
              <h2 className='text-lg font-bold text-slate-800'>Hey, {username}</h2>
            ...
            <div className={TIP_CARD.container}>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  ...
                  <a href="https://www.google.co.in/" target='_blank' className='block mt-2 text-sm text-blue-500 hover:underline'>
                    Visit Google.com
                  </a>
                </div>
              </div>
        ...
        <div className='fixed inset-0 z-40'>
          ...
          <div className={SIDEBAR_CLASSES.mobileDrawer} onClick={(e)=>e.stopPropagation()}>
            <div className='flex justify-between items-center mb-4 border-b pb-2'>
              ...
              <button onClick={()=> setMobileOpen(false)} className='text-slate-700 hover:text-blue-600'>
                <X className='w-5 h-5'/>
              </button>
            </div>
            <div className='flex items-center gap-3 mb-6'>
              ...
              <div>
                <h2 className='text-lg font-bold mt-16 text-slate-800'>Hey, {username}</h2>
                <p className='text-sm text-blue-500 font-medium flex items-center gap-1'>
                  <Sparkles className='w-3 h-3'/> Let's crush some tasks!
                </p>
              </div>
